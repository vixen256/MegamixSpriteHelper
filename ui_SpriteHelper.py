...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.image_edit_area_widget_properties.setGeometry(QRect(0, -671, 199, 905))
        ...
        self.verticalLayoutWidget_3.setGeometry(QRect(0, 0, 201, 901))
        ...
        sizePolicy6.setHeightForWidth(self.export_options_image_tab.sizePolicy().hasHeightForWidth())
        self.export_options_image_tab.setSizePolicy(sizePolicy6)
        self.verticalLayoutWidget = QWidget(self.export_options_image_tab)
        self.verticalLayoutWidget.setObjectName(u"verticalLayoutWidget")
        self.verticalLayoutWidget.setGeometry(QRect(0, 0, 211, 191))
        ...
        sizePolicy7.setHeightForWidth(self.export_options_game_tab.sizePolicy().hasHeightForWidth())
        self.export_options_game_tab.setSizePolicy(sizePolicy7)
        self.verticalLayoutWidget_2 = QWidget(self.export_options_game_tab)
        self.verticalLayoutWidget_2.setObjectName(u"verticalLayoutWidget_2")
        self.verticalLayoutWidget_2.setGeometry(QRect(0, 0, 211, 191))
        ...
        sizePolicy8.setHeightForWidth(self.song_id_label.sizePolicy().hasHeightForWidth())
        self.song_id_label.setSizePolicy(sizePolicy8)
